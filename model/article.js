...
exports.query = function (pageIndex, pageSize, callback) {
  MySQLUtil.query('SELECT * FROM smart_article WHERE createDate <=(' +
  'SELECT createDate FROM smart_article ORDER BY createDate desc LIMIT ?, 1) ' +
  'ORDER BY createDate desc LIMIT ' +pageSize, [(pageIndex - 1) * pageSize], function (rows, fields) {
